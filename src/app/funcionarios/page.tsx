...
export default function FuncionariosPage() {
  ...
  const { employees, loading, importEmployees, deleteEmployee, updateEmployee, createEmployee } = useEmployees("CCM");
  ...
  function exportToExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Funcionários CCM");
    XLSX.writeFile(wb, `funcionarios-ccm-${today}.xlsx`);
  }
